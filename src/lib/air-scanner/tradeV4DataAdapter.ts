...
export function buildTradeV4PageModel(input: {
  ...
  return {
    ...
    noBuyDisplay: snap?.noBuySummary ? {
      ...
      symbolEligibleCount: snap.noBuySummary.symbolEligibleCount,
      symbolCooldownBlockedCount: snap.noBuySummary.symbolCooldownBlockedCount,
      recoveryBlockedCount: snap.noBuySummary.recoveryBlockedCount,
      alreadyOpenBlockedCount: snap.noBuySummary.alreadyOpenBlockedCount,
      pendingBuyBlockedCount: snap.noBuySummary.pendingBuyBlockedCount,
