...
export const STRATEGY_AUDIT_REGISTRY: Record<StrategyAuditKey, StrategyAuditDefinition> = {
  momentum: {
    ...
    requiredSetup: ['momentumConfirmed', 'priceFresh', 'spreadOk', 'tpRoomOk', 'finalExecutable'],
    optionalSetup: ['dipObserved', 'reboundObserved'],
    ...
    reboundRequirement: 'advisory',
    finalExecutableRequirement: 'required',
  },
  balanced: {
    strategyKey: 'balanced',
    strategyLabel: 'Balanced',
    classification: 'momentum / uptrend entry',
    requiredSetup: ['momentumConfirmed', 'priceFresh', 'spreadOk', 'tpRoomOk', 'finalExecutable'],
    optionalSetup: ['dipObserved', 'reboundObserved'],
    blockers: ['spreadOk', 'tpRoomOk', 'priceFresh'],
    metricRoles: {
