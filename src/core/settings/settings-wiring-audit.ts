...
export const settingsWiringAudit = {
  ...
  scannerUniverseSize:  { status: 'WIRED', ui: 'TradingParametersCard', persist: 'AppSettings.scannerUniverseSize', consumer: 'MarketScanner → buildScannerUniverse maxSymbols', note: 'Any positive integer; effective size is bounded only by the eligible Binance universe; legacy maxSymbolsScanned is a compatibility mirror' },
