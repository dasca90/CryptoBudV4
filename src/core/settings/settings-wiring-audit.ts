...
export const settingsWiringAudit = {
  ...
  scannerUniverseSize:  { status: 'WIRED', ui: 'TradingParametersCard', persist: 'AppSettings.scannerUniverseSize', consumer: 'MarketScanner → buildScannerUniverse maxSymbols', note: 'Canonical 20-250 value; legacy maxSymbolsScanned is a compatibility mirror' },
