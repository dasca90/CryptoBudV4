...
function main() {
  ...
  ok(JSON.stringify(V3_OPEN_POSITION_COLUMNS) === JSON.stringify(['Symbol','State','Strategy','Qty','Entry Value','Entry','Ref','Last','Dip','Trend','PnL%','Unrealized','TP1 (%)','TP2 (%)','Stop (%)','Stop Trigger','Decision','Owner','Opened At','Hold']), '15 V3 open default column order exactly');
