...
ok(closed.includes('Sold Positions') && closed.includes('v3-sold-summary') && closed.includes('Realized Total') && closed.includes('Win Rate'), '6 Sold panel header summary matches V3');
